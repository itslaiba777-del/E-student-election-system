          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {departments.map((dept) => {
                ...
                return (
                  <div key={dept.id} className="bg-white border border-[#c0c9bb] rounded-2xl p-6 shadow-xs flex flex-col justify-between space-y-4">
                    ...
                    <div className="border-t border-dashed border-[#c0c9bb] pt-4 mt-2 space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2 pt-1">
                        {deptProgs.length > 0 ? (
                          deptProgs.map((p) => (
                            <span key={p.id} className="px-3 py-1 bg-[#f4f4f0] border border-[#c0c9bb] rounded-lg text-xs font-semibold text-[#1b1c1a] flex items-center space-x-1">
                              <span>🎓</span>
